...
from fastapi.middleware.cors import CORSMiddleware #allows requests from a web frontend running on a different server/port 
...
async def whatsapp_webhook(request: Request):
    ...
    try:
        ...
        user_message = payload["messages"][0]["text"]["body"]
